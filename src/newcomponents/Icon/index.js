const Icons = {
  ...
  attachCamera: (props) => (
    ...
    >
      <svg
        ...
        viewBox="0 0 53 53"
        onClick={()=>{console.log("attachCamera...............")}}
        width="53"
        height="53"
        {...props}
      >
  ...
  attachContacts: (props) => (
    <svg
      ...
      width="53"
      height="53"
      onClick={()=>{console.log("attachContact...............")}} 
      {...props}
    >
      <defs>
  ...
  attachDocument: (props) => (
    ...
    <svg
      ...
      width="53"
      height="53"
      onClick={()=>{console.log("attachDocument...............")}}
      {...props}
    >
      <defs>
  ...
  attachImage: (props) => (
    ...
    <svg
      ...
      width="53"
      height="53"
      onClick={()=>{console.log("attachImage...............")}}
      {...props}
    >
      <defs>
  ...
  attachRooms: (props) => (
    <svg
      ...
      width="53"
      height="53"
      onClick={()=>{console.log("attachRooms...............")}}
      {...props}
    >
      <defs>
